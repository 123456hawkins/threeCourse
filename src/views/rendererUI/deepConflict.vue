...
let line: any, sphere: any, cube: any, plane: any
let scene: any
let camera: any
let axesHelper: any
let renderer: any
...
const init = () => {
    ...
    const plane1 = new THREE.Mesh(plane, physicalMaterial)
    const plane2 = new THREE.Mesh(new THREE.PlaneGeometry(30, 30), physicalMaterial)
    plane1.position.set(50, 50, 60)
    plane2.position.set(60, 60, 60)
    scene.add(plane1)
    scene.add(plane2)
