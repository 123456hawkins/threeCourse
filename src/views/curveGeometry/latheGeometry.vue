...
let line: any, sphere: any, geometry: any, geometry2: any, latheGeometry: any
let scene: any
let camera: any
let axesHelper: any
let renderer: any
...
const initLatheGeometry = () => {
    arr = [new THREE.Vector2(60, 60), new THREE.Vector2(2, 30), new THREE.Vector2(30, 0)]
    const curve = new THREE.SplineCurve(arr)
    const pointsArr = curve.getPoints(1000)
    latheGeometry = new THREE.LatheGeometry(pointsArr, 1000)
}
const initLight = () => {
...
const init = () => {
    ...
    initLight()
    const mesh1 = new THREE.Mesh(latheGeometry, basicMaterial)
