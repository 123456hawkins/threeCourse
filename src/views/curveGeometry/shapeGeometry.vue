...
let line: any, sphere: any, geometry: any, geometry2: any, pathGeometry: any, extrudeGeometry: any, latheGeometry: any, shape: any, shapeGeometry: any
let scene: any
let camera: any
let axesHelper: any
let renderer: any
...
let textureCube: any
let arr: any
let pointMaterial: any, basicMaterial: any
// 加载环境贴图
const initTexture = () => {
    // 加载环境贴图
    // 加载周围环境6个方向贴图
...
const initPathGeometry = () => {
    ...
    pathGeometry = new THREE.ExtrudeGeometry(shape, { extrudePath: curve, steps: 100 })
}
...
const init = () => {
    ...
    const extrudeMesh = new THREE.Mesh(extrudeGeometry, basicMaterial)
    const pathMesh = new THREE.Mesh(pathGeometry, basicMaterial)
    ...
    container.add(pathMesh)
    extrudeMesh.position.set(0, 0, 20)
    pathMesh.position.set(80, 80, 80)
